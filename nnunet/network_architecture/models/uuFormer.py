...
class SwinTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        self.global_conv = nn.Conv3d(in_chans, in_chans, global_patch_size, global_patch_size)
    ...
    def forward(self, x):
        ...
        global_x = self.patch_embed(global_x)
