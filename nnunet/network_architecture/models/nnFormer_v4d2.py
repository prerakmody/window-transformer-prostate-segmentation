...
class OperationBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, kernel_size = 5, stride = 1, drop=0., drop_path=0.,
...
class nnformer_v4d2(SegmentationNetwork):

    def __init__(self, input_channels, num_classes, deep_supervision=True):

        super(nnformer_v4d2, self).__init__()
