...
class SwinTransformer(nn.Module):
    ...
    def __init__(self,
        ...
        #mask_toekn
        self.mask_token = nn.Parameter(torch.zeros(1, 1, self.conv_dim))
...
class nnConv_mae(SegmentationNetwork):

    def __init__(self, input_channels, num_classes, deep_supervision=True):

        super(nnConv_mae, self).__init__()
